...
flags.DEFINE_string('quantize_mode', 'float16',
                    'quantize mode (int8, float16)')
flags.DEFINE_string(
...
def save_trt():
    ...
    if FLAGS.quantize_mode == 'int8':
        conversion_params = trt.DEFAULT_TRT_CONVERSION_PARAMS._replace(
            ...
            max_batch_size=8)
        converter = trt.TrtGraphConverterV2(input_saved_model_dir=FLAGS.weights,
    ...
    trt_engine_nodes = len([1 for n in trt_graph.node
